...
//     // 2. Fetch all user activity data in one go
//     // This is more efficient than a separate query for each user
...
//         const data = doc.data();
//         userActivityMap[doc.id] = data;
//     });

//     // 3. Fetch Firebase Auth user data
...
//     const combined: any[] = usersData.map((user) => {
//         const userActivity = userActivityMap[user.uid] || {};
//         return {
//             ...user,
//             ...authUsersMap[user.uid],
//             // Merge the sectionProfile from userActivity
//             profile: userActivity.sectionProfile || {}, 
//             streak: user.streak || 0,
//             chapterNo: user.chapterNo || 1,
//             progress: user.progress || 0,
//             IsSeg0Approved: user.IsSeg0Approved ?? false,
//             IsSeg1Approved: user.IsSeg1Approved ?? false,
//             IsSeg2Approved: user.IsSeg2Approved ?? false,
//             IsSeg3Approved: user.IsSeg3Approved ?? false,
//             fullName: user.fullName || authUsersMap[user.uid]?.email || "Unknown",
//         };
//     });
...
// // The get-user/:uid route doesn't need to be changed as per the prompt's requirements,
// // but for consistency and future use, you might want to fetch all relevant data there too.
...
//       uid: userDoc.id,
//       ...userData,
//       profile: userActivityData?.sectionProfile || {},
//       IsSeg0Approved: userData?.IsSeg0Approved ?? false,
//       IsSeg1Approved: userData?.IsSeg1Approved ?? false,
